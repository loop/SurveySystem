...
package com.yogeshn.fyp.androidclient.backend.adapters;
 ...
 */
@SuppressWarnings({"JavadocReference", "FieldCanBeLocal", "WeakerAccess", "CanBeFinal", "ConstantConditions"})
public class DynamicListView extends ListView {
    ...
    public List<String> mChesseList;
    ...
    private Bitmap getBitmapWithBorder(View v) {
        ...
        paint.setColor(getResources().getColor(R.color.bluedefault));
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mChesseList, originalItem, getPositionForView(switchView));
